 ...
 *
 * Implementations should provide platform-specific logging mechanisms. The interface lives in
 * the platform-agnostic `:core:common` module; the Android implementation ([AndroidLogger])
 * lives in `:core:data`.
 *
 * @author Sitharaj Seenivasan
 * @date 22 Jun 2025
