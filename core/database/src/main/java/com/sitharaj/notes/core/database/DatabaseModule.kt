...
package com.sitharaj.notes.core.database
...
/**
 * Provides the shared Room database and its DAOs. Lives in `:core:database` so any feature can
 * persist to the single app database.
 */
@Module
