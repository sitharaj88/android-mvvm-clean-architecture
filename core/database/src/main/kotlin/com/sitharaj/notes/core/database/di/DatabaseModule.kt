...
package com.sitharaj.notes.core.database.di

import android.content.Context
import androidx.room.Room
import com.sitharaj.notes.data.local.DatabaseMigrations
...
/**
 * Hilt module owning the Room database, DAO and local data source for the `:core:database`
 * module. Installed in the [SingletonComponent].
 */
@Module
